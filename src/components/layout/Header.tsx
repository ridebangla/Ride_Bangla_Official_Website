        ...
        <div className="flex h-[68px] items-center justify-between px-4 sm:px-6">
          <Link to="/" className="flex items-center gap-3" aria-label="Ride Bangla home" onClick={() => setOpen(false)}>
            ...
            <div className="leading-none">
              <span className="block text-lg font-black tracking-tight text-[#06291f]">Ride <span className="text-brand-green">Bangla</span> <span className="text-sm font-extrabold text-slate-500">Limited</span></span>
