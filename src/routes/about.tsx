  ...
  head: () => ({
    meta: [
      ...
      },
      {
        name: "description",
        content:
          "Ride Bangla is a Bangladesh-based technology company founded in Faridpur, building a connected ecosystem across mobility, food delivery, courier delivery, marketplace and professional digital services.",
      },
      {
        property: "og:title",
      ...
      },
      {
        ...
        content:
          "Ride Bangla is a Faridpur-based technology company building a connected service, mobility, delivery, marketplace and digital ecosystem for Bangladesh.",
      },
      {
        property: "og:url",
...
const copy = {
  en: {
    ...
    headerSubtitle:
      "A Bangladesh-based technology company building a trusted digital service ecosystem from Faridpur.",
    language: "বাংলা",
    founded: "Founded in Faridpur",
    heroTitle:
      "Building a trusted digital ecosystem for everyday services in Bangladesh.",
    p1:
      "Ride Bangla is a Faridpur-founded Bangladesh-based technology initiative focused on building a connected ecosystem across mobility, food delivery, courier delivery, marketplace services and professional digital solutions.",
    p2:
    ...
    p3:
      "Ride Bangla is already operating at an early local stage in Faridpur, with food and courier delivery activity coordinated through its official Facebook page and WhatsApp groups while dedicated customer, rider, partner and agent applications are being developed.",
    contact: "Contact Us",
    viewApps: "View Apps",
    origin: "Origin",
    website: "Website",
    ...
    vision: "Vision",
    visionBody:
      "Build a homegrown technology ecosystem that connects everyday services and gradually expands from a strong Faridpur operating model toward a wider Bangladesh-wide network.",
    values: "Core Values",
    valuesBody:
  ...
  bn: {
    ...
    headerSubtitle:
      "ফরিদপুর থেকে বাংলাদেশভিত্তিক একটি নির্ভরযোগ্য ডিজিটাল সার্ভিস ইকোসিস্টেম গড়ে তোলার উদ্যোগ।",
    language: "English",
    founded: "ফরিদপুরে প্রতিষ্ঠিত",
    heroTitle:
      "বাংলাদেশের দৈনন্দিন সেবার জন্য একটি নির্ভরযোগ্য ডিজিটাল ইকোসিস্টেম গড়ে তোলা।",
    p1:
      "Ride Bangla ফরিদপুরভিত্তিক একটি বাংলাদেশি প্রযুক্তি উদ্যোগ, যার লক্ষ্য Mobility, Food Delivery, Courier Delivery, Marketplace Services এবং Professional Digital Solutions-কে একটি সংযুক্ত ইকোসিস্টেমের মধ্যে নিয়ে আসা।",
    p2:
    ...
    p3:
      "Ride Bangla ইতিমধ্যে ফরিদপুরে প্রাথমিক পর্যায়ে কার্যক্রম পরিচালনা করছে। বর্তমানে অফিসিয়াল Facebook Page ও WhatsApp Groups-এর মাধ্যমে Food এবং Courier Delivery কার্যক্রম সমন্বয় করা হচ্ছে এবং Customer, Rider, Partner ও Agent-এর জন্য পৃথক অ্যাপ্লিকেশন উন্নয়নাধীন।",
    ...
    vision: "ভিশন",
    visionBody:
      "একটি দেশীয় প্রযুক্তি ইকোসিস্টেম তৈরি করা, যা দৈনন্দিন সেবাগুলোকে সংযুক্ত করবে এবং শক্তিশালী ফরিদপুরভিত্তিক মডেল থেকে ধাপে ধাপে সারা বাংলাদেশে বিস্তৃত হবে।",
    values: "মূল মূল্যবোধ",
    valuesBody:
