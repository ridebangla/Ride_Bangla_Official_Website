      ...
      <section className="mx-auto max-w-6xl px-4 py-12">
        <div className="grid gap-8 lg:grid-cols-[1.2fr_0.8fr] lg:items-center">
          <div>
            ...
            <h2 className="mt-4 text-3xl font-bold tracking-tight text-foreground sm:text-4xl">
              Building a local digital ecosystem for everyday services.
            </h2>

            <p className="mt-5 text-base leading-8 text-muted-foreground">
              Ride Bangla is founded in Faridpur, Bangladesh, with a goal to
              make food delivery, homemade food, cakes, restaurants, parcel
              delivery, and document courier service easier for local people,
              riders, partners, and businesses.
            </p>

            <p className="mt-4 text-base leading-8 text-muted-foreground">
              We are working step by step to build a reliable, locally-led
              platform where customers can order with confidence, riders can
              earn with dignity, and partners can grow their business through
              technology.
            </p>
        ...
        <div className="mt-12 grid gap-4 sm:grid-cols-3">
          ...
          <ValueCard
            ...
            title="Core Values"
            body="Trust, transparency, local service, accountability and respect for every user."
          />
        </div>
      </section>
        ...
        <div className="mx-auto max-w-6xl px-4">
          <div className="max-w-3xl">
            ...
            <h2 className="mt-3 text-3xl font-bold tracking-tight">
              Ride Bangla service ecosystem
            </h2>
            <p className="mt-4 text-base leading-8 text-muted-foreground">
              Ride Bangla is being developed as a connected platform for
              customers, riders, partners, agents, wallet services, website
              updates, and central admin control.
            </p>
          </div>
          ...
          <div className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            <FeatureCard
              ...
              title="Food Delivery"
              body="Restaurants, homemade food, cakes and local food ordering."
            />
            <FeatureCard
              icon={<ShieldCheck className="h-6 w-6" />}
              title="Courier Service"
              body="Parcel and document delivery service for daily needs."
            />
            <FeatureCard
              icon={<Users className="h-6 w-6" />}
              title="Rider & Partner"
              body="Separate systems for riders, partners and business growth."
            />
            <FeatureCard
