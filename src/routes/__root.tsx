  ...
  head: () => ({
    meta: [
      ...
      { title: "Ride Bangla — Ride. Food. Delivery. Courier." },
      {
        name: "description",
        content:
          "Ride Bangla is a Bangladesh-based multi-service technology ecosystem for ride sharing, food delivery, courier delivery, marketplace services and professional digital solutions.",
      },
      ...
      },
      {
        ...
        content:
          "Ride sharing, food delivery, courier delivery, marketplace services and Ride Bangla Studio digital solutions for Bangladesh.",
      },
