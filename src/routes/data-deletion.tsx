  ...
  return (
    <SiteLayout>
      <PageHeader
        ...
        subtitle="This page has moved to Delete Account & Data"
      />

      <article className="prose prose-sm mx-auto max-w-3xl px-4 py-10 text-foreground">
        <div className="not-prose mb-8 rounded-3xl border border-brand-green/20 bg-brand-green-soft p-5 shadow-sm">
          <h2 className="text-base font-extrabold text-brand-green">
            Updated Account & Data Deletion Page
          </h2>
          <p className="mt-2 text-sm leading-6 text-foreground">
            Ride Bangla now uses one official page for account deletion and
            personal data deletion instructions. Please use the updated page
            below.
          </p>
          <a
            className="mt-4 inline-flex rounded-full bg-brand-green px-5 py-3 text-sm font-extrabold text-white hover:opacity-90"
            href="/delete-account"
          >
            Go to Delete Account & Data
          </a>
        </div>
        ...
        <div className="not-prose my-6 rounded-3xl border border-brand-green/20 bg-brand-green-soft p-5 shadow-sm">
          ...
          <div className="mt-4 space-y-4">
            ...
            <StepItem number="2">
              Go to <strong>Account → Delete Account</strong>.
            </StepItem>
            ...
            <StepItem number="4">
              ...
              account:{" "}
              <strong>
                Facebook → Settings → Apps and Websites → Ride Bangla → Remove
              </strong>
              .
            </StepItem>
          </div>
        ...
        <p className="text-sm text-muted-foreground">
          ...
          . The official account deletion page is{" "}
