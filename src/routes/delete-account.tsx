  ...
  return (
    <SiteLayout>
      ...
      <article className="prose prose-sm mx-auto max-w-3xl px-4 py-10 text-foreground">
        ...
        <h2 className="mt-6 text-lg font-semibold">Manual Account Deletion Request</h2>
        <p className="text-sm text-muted-foreground">
          If you cannot access the app or need help deleting your account, email
          us from the email address connected to your Ride Bangla account. Please
        ...
        <p className="text-sm text-muted-foreground">
          Ride Bangla processes account deletion requests within 30 days after
