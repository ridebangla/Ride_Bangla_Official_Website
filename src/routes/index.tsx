        ...
        */}
        ...
        <section className="relative overflow-hidden bg-[#06291f] px-5 py-20 text-white sm:px-8 lg:py-24">
          ...
          <div className="relative mx-auto max-w-7xl">
            ...
            {/*
              Real IT team photo — shown complete, full width, no cropping.
              Every name/role/title in this photo is already real (baked
              in by the team themselves), so we don't repeat any of it in
              code — this is just the photo, displayed as-is.
            */}
            <div className="relative mt-14">
              <img
                src="/assets/it-team.jpg"
                alt="The Ride Bangla IT Company team"
        ...
        {/*
          APP DOWNLOAD — this is now literally your full banner image,
          shown complete on every device (laptop, desktop, mobile) with
          no cropping: an <img> at width:100%/height:auto instead of a
          cropped CSS background, so nothing of the design gets cut off.
          Because the banner itself already contains the heading, the
          feature strip and the Google Play / App Store button graphics,
          we do NOT re-draw duplicate text/buttons on top of it (that
          would double everything). Instead the whole banner is one real,
          working link — tap anywhere (including the store buttons) and
          it goes to the real /apps page.
        */}
        <section className="px-5 py-16 sm:px-8 lg:py-20">
          <div className="mx-auto max-w-7xl">
            <Link
              to="/apps"
              aria-label="Ride Bangla App — coming soon, open the Apps page"
              className="block overflow-hidden rounded-[2rem] shadow-[0_25px_80px_rgba(0,45,30,.18)] transition hover:brightness-[1.03]"
            >
              <img
                src="/assets/app-download-hero.jpg"
                alt="Ride Bangla App — Coming Soon. 24/7 delivery service. Order food, book a ride, send parcels, track in real-time and more, all in one app."
                className="block h-auto w-full"
              />
            </Link>

            {/*
              Real QR code, added below the banner (not overlapping any of
              its baked-in graphics). Generated at render time from the
              actual /apps URL — not a static/fake image.
            */}
            <div className="mt-5 flex items-center gap-3 rounded-2xl border border-slate-100 bg-white p-3 shadow-sm sm:w-fit">
              <img
              ...
              <p className="text-xs font-bold leading-tight text-slate-500">
                Scan to get notified the moment our app launches.
              </p>
            </div>
          </div>
        </section>
