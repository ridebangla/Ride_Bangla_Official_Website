...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      {
        title:
          "Ride Bangla — Ride Sharing, Delivery, Marketplace & Digital Services",
      },
      {
        name: "description",
        content:
          "Ride Bangla is a multi-service technology ecosystem for ride sharing, food delivery, courier delivery, marketplace services and professional digital solutions in Bangladesh.",
      },
      {
        property: "og:title",
        content: "Ride Bangla — Multi-Service Technology Ecosystem",
      },
      {
        property: "og:description",
        content:
          "Ride sharing, food delivery, courier delivery, marketplace and Ride Bangla Studio services connected through one official ecosystem.",
      },
    ...
    <SiteLayout>
          ...
          <div className="grid items-center gap-12 md:grid-cols-2">
            <div className="min-w-0">
              ...
              <h1 className="max-w-2xl text-4xl font-extrabold leading-tight tracking-tight text-foreground sm:text-5xl md:text-6xl">
                {language === "bn"
                  ? "বাংলাদেশের জন্য রাইড শেয়ারিং, ডেলিভারি, মার্কেটপ্লেস ও ডিজিটাল সেবা"
                  : "Ride Sharing, Delivery, Marketplace & Digital Services for Bangladesh"}
              </h1>

              <p className="mt-5 max-w-xl text-base leading-8 text-muted-foreground sm:text-lg">
                {language === "bn"
                  ? "Ride Bangla রাইড শেয়ারিং, ফুড ডেলিভারি, কুরিয়ার ডেলিভারি, মার্কেটপ্লেস এবং পেশাদার ডিজিটাল সেবার মাধ্যমে গ্রাহক, পার্টনার, রাইডার, এজেন্ট ও ব্যবসাকে এক প্ল্যাটফর্মে যুক্ত করে।"
                  : "Ride Bangla connects customers, partners, riders, agents and businesses through ride sharing, food delivery, courier delivery, marketplace and professional digital services."}
              </p>
      ...
      <section className="mx-auto max-w-6xl px-4 py-10 sm:py-14">
        <div className="rounded-3xl border border-brand-green/15 bg-gradient-to-br from-brand-green-soft to-background p-6 shadow-lg sm:p-8">
          ...
          <p className="mt-3 max-w-4xl text-base leading-7 text-muted-foreground">
            Ride Bangla is founded in Faridpur, Bangladesh. The ecosystem brings
            together Ride Sharing, Food Delivery, Courier Delivery, Marketplace,
            Customer, Partner, Rider and Agent platforms, alongside Ride Bangla
            Studio for app, website, graphics and other professional digital services.
          </p>
          <Link
            to="/about"
      ...
      <section className="mx-auto max-w-6xl px-4 py-10 sm:py-12">
        ...
        <p className="mt-3 max-w-3xl text-base leading-7 text-muted-foreground">
          ...
          services together through one connected company ecosystem.
        </p>
