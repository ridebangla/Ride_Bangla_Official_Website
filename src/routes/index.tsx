      ...
      <div className="rb-home overflow-hidden">
        ...
        */}
        <section className="relative overflow-hidden bg-white px-5 py-16 sm:px-8 lg:py-20">
          <div className="mx-auto max-w-7xl overflow-hidden rounded-[2rem] shadow-[0_25px_80px_rgba(0,45,30,.12)] lg:grid lg:grid-cols-[1fr_auto_1fr]">
            ...
            {/*
              Center portrait — VISUAL ONLY, no text baked in.
              Drop a real Ride Bangla team/rider portrait at
              /public/assets/about-photo.jpg. Until it's uploaded this
              slot just shows a neutral placeholder — no fake photo.
            */}
            <div
              className="relative hidden w-[280px] shrink-0 bg-cover bg-top lg:block xl:w-[320px]"
              style={{ backgroundImage: "url('/assets/about-photo.jpg')" }}
            >
              <div className="absolute inset-0 bg-gradient-to-r from-[#06291f]/10 via-transparent to-white/10" />
            </div>
              ...
              <div className="mt-8 flex flex-wrap items-center gap-5">
                ...
                */}
                <div className="flex items-center gap-3 rounded-2xl border border-slate-100 bg-white p-3 shadow-sm">
                  <img
                    src={`https://api.qrserver.com/v1/create-qr-code/?size=132x132&margin=0&data=${encodeURIComponent("https://ridebangla.bd/apps")}`}
                  ...
                  />
                  <div className="max-w-[110px] text-[10px] font-bold leading-tight text-slate-500">
