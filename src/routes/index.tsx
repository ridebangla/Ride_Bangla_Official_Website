...
import { getHomeContent, getWebsiteUpdates, saveWebsiteSubscriber } from "@/lib/website-data";
...
function HomePage() {
  ...
  const { data: updates } = useQuery({
    ...
    retry: false,
    queryFn: async () => getWebsiteUpdates(3),
  });
  ...
  async function handleSubscribe(event: FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      setSubscribeStatus("success");
      setSubscribeMessage(
        "Thank you! Your email has been saved. You will receive Ride Bangla website updates."
      );
    }
  }
